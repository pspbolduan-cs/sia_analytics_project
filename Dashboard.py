...
def run_streamlit_ui():
    ...
    # Helper: dedent HTML/CSS so Streamlit doesn't treat it as a code block
    def md_html(s: str):
...
""")
    ...
    # ---------------------------------------------------
    md_html('<div class="sectionTitle">📌 What this dashboard does</div>')
    md_html('<div class="sectionSub">A single entry point that explains the system and links to four analytics modules built on the same dataset + shared services.</div>')
...
""")
    ...
    # ---------------------------------------------------
    # MODULES SECTION (images fill entire top area)
    # ---------------------------------------------------
    md_html('<div style="height:18px;"></div>')
    md_html('<div class="sectionTitle">📊 Analytics Modules</div>')
    md_html('<div class="sectionSub">Click <b>Open module →</b> to navigate. Each module uses the same theme and dataset service.</div>')
...
"""
    ...
    md_html("<div style='height:16px;'></div>")
